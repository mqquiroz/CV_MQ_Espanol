...
\printbibliography[heading={subbibliography},title={Artículos Indexados (Journal Articles)},type=article]

\printbibliography[heading={subbibliography},title={Conferencias (Conference Proceedings)},type=inproceedings]
